...
<div class="container" id="containerassoc">
	<div class="bar">
		...
		<aside class="col-md-4">
			<div id="branches">
				<ul>
					<li><h3>Dans notre groupe, il existe deux branches :</h3></li>
		...
		<div class="nocontainer">
			...
			<div class="bar" id="valeurs">
				<div id="textegauche">
					<ul>
						<li><h3 class="lobster">Nos valeurs</h3></li>
						...
						<li><img src="<?= $this->assetUrl('img/feuille2.png')?>"> En apprenant à connaître et à comprendre le monde, en agissant pour protéger et faire respecter équilibre et harmonie, c’est notre engagement pour l’environnement.</li>
					</ul>
				</div>
			</div>
		</div>
